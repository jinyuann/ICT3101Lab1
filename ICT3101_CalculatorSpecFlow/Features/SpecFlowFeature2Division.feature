Feature: SpecFlowFeature2Division
...
Scenario: Dividing two numbers
	...
	Then the division decimal result should be "0.5"
...
@Divisions
Scenario: Dividing by negative zeros
	Given I have a calculator
	When I have entered "15" and "-0" into the calculator and press divide
	Then the division result should be negative infinity
